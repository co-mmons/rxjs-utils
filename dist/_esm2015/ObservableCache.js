    ...
    constructor(factoryOrParams, factoryOrParamsOrId) {
        ...
        if (typeof factoryOrParamsOrId === "string") {
            ...
            if (typeof params.keepValue === "boolean") {
                __classPrivateFieldSet(this, _ObservableCache_keepValue, params.keepValue, "f");
            }
            if (typeof params.keepAlive === "boolean") {
                __classPrivateFieldSet(this, _ObservableCache_keepAlive, params.keepAlive, "f");
            }
            if (typeof params.checkEquality === "boolean") {
                __classPrivateFieldSet(this, _ObservableCache_checkEquality, params.checkEquality, "f");
            }
        }
    }
